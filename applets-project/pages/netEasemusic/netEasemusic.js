...
Page({
    ...
    getSwiperlist() { //获取轮播图数据
        netEaseAPI('banner?type=2').then(res => {
            ...
            this.setData({swiperList: res.data.banners})
        })
    },
    ...
    playlist(e){
        netEaseAPI('playlist/detail',{id:e.detail}).then(res=>{
            ...
            netEaseAPI('song/detail?',{ids:Idtext}).then(res=>{
